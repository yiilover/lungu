...
$LANG['collection'] = '收藏产品';
$LANG['index'] = '首页';
$LANG['logout'] = '退出';
$LANG['hellow'] = '你好';
$LANG['add_child_menu'] = '添加子菜单';
$LANG['online_publish'] = '产品发布';
$LANG['published_content'] = '已发布产品';
...
$LANG['sina_login_notice'] = '使用新浪微博连接登录轮毂网,将精彩内容分享到新浪微博。';
$LANG['qq_login_notice'] = '使用腾讯微博连接登录轮毂网,将精彩内容分享到腾讯微博。';
$LANG['snda_login_notice'] = '使用用盛大连接登录轮毂网,轻松使用盛大所有服务。';
